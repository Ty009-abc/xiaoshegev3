...
function buildSystemPrompt () {
  return [
    ...
    'card03 系统困局：structuralMechanism + worldRule（4条以内 + 1句结论，<=220字）。',
    'card04 翻身路径：strategicMigration（from → to + logic，<=140字）。',
    'card05 行动建议：ONE 主实验 + 2–3 条支撑步骤，含 TARGET / TIMEBOX / SUCCESS SIGNAL（<=220字）。',
    '',
    '== 输出契约 ==',
